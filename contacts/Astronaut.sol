 ...
 *
 *                              NFT Contract
 * Author: Group 13 | Astronaut
 * StudentID1: 63070503409
 * StudentID2: 63070503443
 * StudentID3: 63070503457
 * ContractName: Astronaut
 *
 **********************************************************************************
 */
...
contract Astronaut is ERC721A {
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "Astronaut: not owner");
        _;
    }
     ...
     */
    constructor() ERC721A("Astronaut NFT", "AST") {
        owner = msg.sender;
    }
    ...
    function tokenURI(
        ...
        require(_exists(tokenId), "Astronaut: not exist");
